...
GArray * sc_vertices = NULL;
GList * sc_faces = NULL;

void simple_cube_setup(void)
{
...
void simple_cube_teardown(void)
{
...
Suite * obj_parser_suite()
{
  ...
  TCase *simple_cube_tc = tcase_create("simple_cube");
  tcase_add_unchecked_fixture(simple_cube_tc, simple_cube_setup, simple_cube_teardown);
  tcase_add_test(simple_cube_tc, test_simple_cube_first_vertex);
  tcase_add_test(simple_cube_tc, test_simple_cube_last_vertex);
  tcase_add_test(simple_cube_tc, test_simple_cube_first_face);
  tcase_add_test(simple_cube_tc, test_simple_cube_last_face);
